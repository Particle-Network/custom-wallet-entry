...
const Header: React.FC = () => {
    const headContent = {
        title: 'Particle Auth Core Demo',
        metaDescription: 'Particle Auth with Account Abstraction Code demo in Next JS.',
        favicon: '/favicon.ico',
    };
    ...
    const subHeading = 'How to customize your wallet interaction';
