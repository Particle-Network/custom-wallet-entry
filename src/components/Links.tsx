...
const links = [
    ...
    },
    {
        ...
        title: 'Dashboard →',
        description: 'Manage your projects and team, View analytics data, Custom configuration.',
    },
    {
    ...
    return (
        <>
            <h2 className="text-2xl font-bold mt-8 mb-6 text-center">
                ...
                >
                    <img src={repositoryLink.imgSrc} alt={repositoryLink.imgAlt} className="w-6 h-6 mr-2" />
                    {repositoryLink.text}
                </a>
            </h2>
            <p className="text-xl mb-12 text-center">
                {codeText.text} <code className="bg-gray-800 rounded p-1 text-purple-300">{codeText.code}</code>
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
                {links.map((link, index) => (
                    ...
                    >
                        <h2 className="text-2xl font-semibold mb-2 text-purple-400">{link.title}</h2>
